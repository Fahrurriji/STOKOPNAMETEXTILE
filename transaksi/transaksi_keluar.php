...
// Query mengambil data transaksi, pelanggan, dan admin
        ...
        <tr>
          ...
          <td>
            <div class="action-btns">
              ...
              <a href="javascript:void(0)" onclick="confirmDelete('hapus_keluar.php?id=<?= $r['id'] ?>','<?= htmlspecialchars($r['no_transaksi']) ?>')" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></a>
            </div>
          </td>
        </tr>
      <?php endwhile; ?>
...
<script>
function confirmDelete(url, no) {
    if (confirm("Hapus transaksi " + no + "? Stok barang akan otomatis bertambah kembali.")) {
